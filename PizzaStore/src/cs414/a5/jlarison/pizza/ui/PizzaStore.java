...
import cs414.a5.jlarison.pizza.controller.LoginController;
...
import cs414.a5.jlarison.pizza.dao.LoginDAO;
...
public class PizzaStore {
	...
	private void initialize() {
		...
		frmPizzaStoreLauncher.setIconImage(Toolkit.getDefaultToolkit().getImage(PizzaStore.class.getResource("/cs414/a5/jlarison/pizza/ui/Pizza-icon.png")));
